...
add wave -noupdate /ARMCPU_testbench/armcp/Blt64
add wave -noupdate /ARMCPU_testbench/armcp/Bltout
add wave -noupdate /ARMCPU_testbench/armcp/nextBlt
...
add wave -noupdate -childformat {{{/ARMCPU_testbench/armcp/data/mem[16]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[15]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[14]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[13]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[12]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[11]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[10]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[9]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[8]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[7]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[6]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[5]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[4]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[3]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[2]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[1]} -radix decimal} {{/ARMCPU_testbench/armcp/data/mem[0]} -radix decimal}} -expand -subitemconfig {{/ARMCPU_testbench/armcp/data/mem[16]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[15]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[14]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[13]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[12]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[11]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[10]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[9]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[8]} {-radix decimal} {/ARMCPU_testbench/armcp/data/mem[7]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[6]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[5]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[4]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[3]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[2]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[1]} {-height 15 -radix decimal} {/ARMCPU_testbench/armcp/data/mem[0]} {-height 15 -radix decimal}} /ARMCPU_testbench/armcp/data/mem
...
WaveRestoreCursors {{Cursor 1} {36115397499 ps} 0}
